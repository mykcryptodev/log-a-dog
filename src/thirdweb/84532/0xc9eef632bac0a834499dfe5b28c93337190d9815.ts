...
/**
 * Calls the "POOL_CONFIG" function on the contract.
 * @param options - The options for the POOL_CONFIG function.
 * @returns The parsed result of the function call.
 * @example
 * ```
 * import { POOL_CONFIG } from "TODO";
 *
 * const result = await POOL_CONFIG();
 *
 * ```
 */
export async function POOL_CONFIG(
...
/**
 * Calls the "ZORA_FACTORY" function on the contract.
 * @param options - The options for the ZORA_FACTORY function.
 * @returns The parsed result of the function call.
 * @example
 * ```
 * import { ZORA_FACTORY } from "TODO";
 *
 * const result = await ZORA_FACTORY();
 *
 * ```
 */
export async function ZORA_FACTORY(
  options: BaseTransactionOptions
) {
  return readContract({
    contract: options.contract,
...
/**
 * Represents the parameters for the "getBulkUserHotdogLogCount" function.
 */
export type GetBulkUserHotdogLogCountParams = {
  users: AbiParameterToPrimitiveType<{"internalType":"address[]","name":"users","type":"address[]"}>
};

/**
 * Calls the "getBulkUserHotdogLogCount" function on the contract.
 * @param options - The options for the getBulkUserHotdogLogCount function.
 * @returns The parsed result of the function call.
 * @example
 * ```
 * import { getBulkUserHotdogLogCount } from "TODO";
 *
 * const result = await getBulkUserHotdogLogCount({
 *  users: ...,
 * });
 *
 * ```
 */
export async function getBulkUserHotdogLogCount(
  options: BaseTransactionOptions<GetBulkUserHotdogLogCountParams>
) {
  return readContract({
    contract: options.contract,
    method: [
...
/**
 * Calls the "zoraEnabled" function on the contract.
 * @param options - The options for the zoraEnabled function.
 * @returns The parsed result of the function call.
 * @example
 * ```
 * import { zoraEnabled } from "TODO";
 *
 * const result = await zoraEnabled();
 *
 * ```
 */
export async function zoraEnabled(
  options: BaseTransactionOptions
) {
  return readContract({
    contract: options.contract,
...
export function logHotdog(
  ...
  [
    ...
    params: [options.imageUri, options.metadataUri, options.eater, options.poolConfig]
  });
};
...
/**
 * Represents the parameters for the "setZoraEnabled" function.
 */
export type SetZoraEnabledParams = {
  zoraEnabled: AbiParameterToPrimitiveType<{"internalType":"bool","name":"_zoraEnabled","type":"bool"}>
};

/**
 * Calls the "setZoraEnabled" function on the contract.
 * @param options - The options for the "setZoraEnabled" function.
 * @returns A prepared transaction object.
 * @example
 * ```
 * import { setZoraEnabled } from "TODO";
 *
 * const transaction = setZoraEnabled({
 *  zoraEnabled: ...,
 * });
 *
 * // Send the transaction
 ...
 * ```
 */
export function setZoraEnabled(
  options: BaseTransactionOptions<SetZoraEnabledParams>
) {
  return prepareContractCall({
    contract: options.contract,
    method: [
