...
/**
 * Represents the filters for the "DogValidityUpdated" event.
 */
export type DogValidityUpdatedEventFilters = Partial<{
  logId: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"uint256","name":"logId","type":"uint256"}>
eater: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"eater","type":"address"}>
}>;

/**
 * Creates an event object for the DogValidityUpdated event.
 * @param filters - Optional filters to apply to the event.
 * @returns The prepared event object.
 * @example
 * ```
 * import { getContractEvents } from "thirdweb";
 * import { dogValidityUpdatedEvent } from "TODO";
 *
 * const events = await getContractEvents({
 * contract,
 * events: [
 *  dogValidityUpdatedEvent({
 *  logId: ...,
 *  eater: ...,
 * })
 * ],
 ...
 * ```
 */
export function dogValidityUpdatedEvent(filters: DogValidityUpdatedEventFilters = {}) {
  return prepareEvent({
    signature: "event DogValidityUpdated(uint256 indexed logId, address indexed eater, bool isValid, uint256 timestamp)",
    filters,
  });
};
...
/**
 * Represents the parameters for the "getDogsInTimeRange" function.
 */
export type GetDogsInTimeRangeParams = {
...
offset: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"offset","type":"uint256"}>
limit: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"limit","type":"uint256"}>
};

/**
 * Calls the "getDogsInTimeRange" function on the contract.
 * @param options - The options for the getDogsInTimeRange function.
 * @returns The parsed result of the function call.
 * @example
 * ```
 * import { getDogsInTimeRange } from "TODO";
 *
 * const result = await getDogsInTimeRange({
 *  startTime: ...,
 *  endTime: ...,
 *  offset: ...,
 *  limit: ...,
 ...
 * ```
 */
export async function getDogsInTimeRange(
  options: BaseTransactionOptions<GetDogsInTimeRangeParams>
) {
  return readContract({
    contract: options.contract,
    method: [
  ...
  [
    ...
    params: [options.startTime, options.endTime, options.offset, options.limit]
  });
};
...
/**
 * Represents the parameters for the "emitValidityUpdate" function.
 */
export type EmitValidityUpdateParams = {
  logId: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"logId","type":"uint256"}>
};

/**
 * Calls the "emitValidityUpdate" function on the contract.
 * @param options - The options for the "emitValidityUpdate" function.
 * @returns A prepared transaction object.
 * @example
 * ```
 * import { emitValidityUpdate } from "TODO";
 *
 * const transaction = emitValidityUpdate({
 *  logId: ...,
 * });
 *
 * // Send the transaction
 ...
 * ```
 */
export function emitValidityUpdate(
  options: BaseTransactionOptions<EmitValidityUpdateParams>
) {
  return prepareContractCall({
    contract: options.contract,
    method: [
