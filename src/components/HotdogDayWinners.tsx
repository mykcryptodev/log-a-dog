    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-0.5 text-sm text-base-content/70">
          Dog #{logId} · National Hotdog Day winner
        </p>
      </div>
    ...
    <section className="w-full space-y-3">
      <div className="text-center">
        <h2 className="font-display text-2xl font-bold tracking-tight">
          🌭 NATIONAL HOTDOG DAY WINNERS
        </h2>
        <p className="mt-1 text-sm text-base-content/70">
          $50 in $HOTDOG airdropped for logging a dog on National Hotdog Day
        </p>
      </div>
      <div className="pop-card space-y-2 rounded-2xl bg-base-100 p-3">
        {HOTDOG_DAY_WINNERS.map((winner) => (
