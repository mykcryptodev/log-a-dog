    ...
    <div>
      ...
      <div className="modal modal-bottom sm:modal-middle" role="dialog">
        <div className="modal-box">
          ...
          <div className="max-h-96 p-4 overflow-y-scroll rounded-lg shadow-inner bg-gradient-to-br from-primary to-secondary">
            ...
            <div className="flex items-center justify-center w-full">
              <ConnectButton
                ...
                connectButton={{
                  ...
                  className: "thirdweb-btn-xs-link-secondary",
                }}
                connectModal={{
